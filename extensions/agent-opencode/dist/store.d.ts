 ...
 */
export declare function effectiveOpenCodeRoot(environment?: NodeJS.ProcessEnv): string;
 ...
 */
export declare function safeStorePath(candidate: string, root: string): Promise<string | undefined>;
...
export declare class OpenCodeStore {
    ...
    eventsAfter(aggregateId: string, afterSeq: number): readonly OpenCodeEventRow[];
    close(): void;
}
