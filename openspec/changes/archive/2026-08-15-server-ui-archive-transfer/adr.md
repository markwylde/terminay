...
## Decisions recorded
_No durable architectural decisions were introduced by this change._ It removes
the last place where a protocol-blind host understood Terminay's build layout,
which is the contract ADR-0008 requires, and keeps installation inside the
origin-bound partition of ADR-0005.
