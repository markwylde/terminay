...
- [x] 1.5 Rebuild the packaged app and confirm the built-in inventory carries seven extensions and no Cursor. Verified by reading `built-in-extensions/inventory.v1.json` from the build output.
