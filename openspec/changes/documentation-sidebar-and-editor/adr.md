...
_No durable architectural decisions were introduced by this change._ Catalog
traversal running on the exact project environment follows ADR-0009, and the
absence of any Desktop-only documentation IPC follows ADR-0008.
