...
_No durable architectural decisions were introduced by this change._ It closes a
gap in the trust-boundary model recorded by ADR-0011 rather than revising the
model, and it does not alter the runtime, bundle-delivery, or PWA framing
