...
- `openspec/adr/0012-pwa-framed-session-host.md` — Keep the installable PWA on the manager origin and frame the session origin, with an origin-keyed manager vault and a closed origin-checked host message schema.
