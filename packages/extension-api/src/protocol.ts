...
export const EXTENSION_OPERATION_NAMES = [
	...
	'extensions.update',
	'extensions.rollback',
	'project-environments.list-providers',
	'project-environments.list-profiles',
	'project-environments.get-profile-form',
	'project-environments.validate-profile',
	'project-environments.save-profile',
	'project-environments.delete-profile',
	'project-environments.get-create-form',
	'project-environments.validate-create',
	'project-environments.create',
	'project-environments.get-operation',
	'project-environments.cancel-operation',
	'project-environments.list-environments',
	'project-environments.get-environment',
	'project-environments.invoke-action',
] as const;
...
export const EXTENSION_EVENT_NAMES = [
	...
	'project-environments.providers-changed',
	'project-environments.profiles-changed',
	'project-environments.environments-changed',
	'project-environments.operation-changed',
] as const;
