...
export interface DictationProviderAdapter {
	readonly transcribe: (
		...
		| DictationProviderResult
		| string
		| Promise<DictationProviderResult | string>;
}
...
export interface AiTargetAuthority {
	...
	readonly getTarget: (
		...
		| TerminalTargetState
		| undefined
		| Promise<TerminalTargetState | undefined>;
...
export interface AiMetadataServiceOptions {
	...
	readonly settings?:
		| AiMetadataSettings
		| (() => AiMetadataSettings | Promise<AiMetadataSettings>);
...
export interface DictationServiceOptions {
	...
	readonly credentialResolver?: AiProviderCredentialResolver;
	readonly settings?:
		| (() => DictationSettings | Promise<DictationSettings>)
		| DictationSettings;
	readonly limits?: AiServiceLimits;
	readonly now?: () => number;
	readonly logger?: AiServiceLogger;
