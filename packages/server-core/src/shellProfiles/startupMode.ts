...
const POSIX_STARTUP_MODE_SHELLS = new Set([
	'bash',
	'dash',
	'fish',
	'ksh',
...
export function shellStartupModeFamily(
	executable: string,
): ShellStartupModeFamily | null {
	...
	if (name !== undefined && POWERSHELL_STARTUP_MODE_SHELLS.has(name))
		return 'powershell';
	return null;
}
