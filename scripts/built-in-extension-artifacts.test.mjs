...
test('all eight built-ins stage as verified offline trees and Electron/standalone copies remain byte-identical', async () => {
  ...
  try {
    ...
    assert.equal(result.inventory.artifacts.length, 8);
