...
test('secret values remain behind privileged preload APIs', () => {
  ...
  assert.match(macrosWindow, /macroCapability\.saveSecret/)
  assert.match(macrosWindow, /macroCapability\.deleteSecret/)
  assert.match(macrosWindow, /useLegacyMacroSettingsCapability/)
