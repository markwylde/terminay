 ...
 * transports, fake bounded channels, filesystem fixtures, and the canonical
 * device-key authentication contract; this list deliberately does not
 * represent a real hosted/browser pairing run.
 */
...
export const TASK19_APPLICATION_PROTOCOL_DOMAINS = Object.freeze({
	...
	remote: 'packages/server-core/test/remote-channel-transport.test.mjs',
	pairing: 'packages/server-core/test/remote-pairing.test.mjs',
	deviceAuthentication: 'packages/server-core/test/remote-device-authentication.test.mjs',
})
